...
1- data : as an argument 
2- return an arr: names of artists who lived in 20 century.

*/

function get20s(artists) {
  let newArr = artists.filter((artist) => {
 ...
 *
 * 1 - function inculde 2 ARG : arr , index number
 * 2 -
 */
...
// console.log(addArtist(artists, 21, 'Yvette', '1996 - current','Web Design', 'Vietnamese', '"Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor'))
...
function lotsOfArt(arr) {
  let nameArr = artists.filter((artist) => artist.paintings > 100);
  return nameArr;
}
